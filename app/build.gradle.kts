...
dependencies {
    ...
    androidTestImplementation("androidx.test.ext:junit:1.2.0-alpha03") //Check this during merge
    androidTestImplementation("androidx.test.espresso:espresso-core:3.6.0-alpha03") //check
